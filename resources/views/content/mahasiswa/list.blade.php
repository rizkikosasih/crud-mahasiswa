...
<div class="card">
  <div class="card-header d-flex justify-content-between">
    <div class="d-flex gap-3">
      ...
      <button type="button" class="btn btn-outline-{{ isset($_COOKIE['theme']) && $_COOKIE['theme'] === 'dark' ? 'light' : 'dark' }} bg-gradient btn-sm tooltips" title="Switch Theme" id="btn-theme">
        <i class="ti ti-{{ isset($_COOKIE['theme']) && $_COOKIE['theme'] === 'dark' ? 'moon' : 'sun' }}"></i>
      </button>
    </div>
